...
class Service:
    ...
    # 이미지 포함 검색
    def imgSearch(self, numOfRows, pageNo, option, searchWord):
        cmd = 'selectMushroomImageList?'
        url = self.base_url + cmd + '&serviceKey=' + self.api_key + '&option'+ option + '&searchWord=' + searchWord + '&numOfRows=' + numOfRows + '&pageNo=' + pageNo
